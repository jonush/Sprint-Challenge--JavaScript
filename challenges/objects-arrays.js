...
// STRETCH: array method .foreach converted to an arrow function
...
// STRETCH: array method .map converted into arrow function
...
// const populationTotal = zooAnimals.reduce(function(accumulator, index){
// 	return accumulator + index.population;
// }, 0);

// STRETCH: array method .reduce converted to an arrow function
const populationTotal = zooAnimals.reduce((accumulator, index) => {return accumulator + index.population}, 0);
